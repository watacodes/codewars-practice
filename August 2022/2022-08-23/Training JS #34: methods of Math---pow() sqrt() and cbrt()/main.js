...
Codewars, 8k: Training JS #34: methods of Math---pow() sqrt() and cbrt()
...
// n volume is a volume of cube, hence the formula would be
// length * width * height

const cutCube = (volume, n) => Number.isInteger(Math.cbrt(volume)) && Number.isInteger(Math.cbrt(volume / n));
