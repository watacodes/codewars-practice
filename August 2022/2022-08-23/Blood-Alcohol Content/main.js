...
Codewars, 8k: Blood-Alcohol Content
...
function bloodAlcoholContent(drinks, weight, sex, time){
  if (sex === 'male') return Number(((drinks.ounces * drinks.abv * 5.14 / weight * 0.73) - 0.015 * time).toFixed(4));
  return Number(((drinks.ounces * drinks.abv * 5.14 / weight * 0.66) - 0.015 * time).toFixed(4));
}