...
Codewars, 8k: Pole Vault Starting Marks
...
// A vaulter with a height of 1.52 metres should start at 9.45 metres.
// A valuter with a height of 1.83 metres should start at 10.67 metres.

// input -> vaulter's height in metres
// output -> the best starting mark in metres, two decimal places.

const startingMark = bodyHeight => 
  (a => +(a * bodyHeight + 9.45 - a * 1.52).toFixed(2))
