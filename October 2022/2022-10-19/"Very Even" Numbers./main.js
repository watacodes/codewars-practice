...
const isVeryEvenNumber = n => {
  ...
  let numToDigits = String(n).split('');
  let sumOfDigits = numToDigits.reduce((acc, curr) => acc + +curr, 0);
  return sumOfDigits >= 10 ? isVeryEvenNumber(sumOfDigits) : sumOfDigits % 2 === 0 ? true : false;
};
